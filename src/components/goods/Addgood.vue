<template>
  <div>
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button type="primary" class="addGoodBtn" @click="addGoods"
              >添加商品</el-button
            >
          </el-tab-pane>
        </el-tabs>
    ...
    <el-dialog title="图片预览" :visible.sync="previewDialog" width="50%">
      <img class="previewPic" :src="previewUrl" alt="" />
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    beforeTabLeave(activeName, oldActiveName) {
      console.log(`离开${oldActiveName}到${activeName}`);
